...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            login(data.data.user); // update global auth state
            navigate('/main');
        } catch (err) {
            ...
            <div className={`${styles["login-wrapper"]} ${styles.bodyly}`}>
                ...
                <div className={styles["login-form-section"]}>
                    <div className={styles["form-wrapper"]}>
                        ...
                        {/* Error Message */}
                        {error && (
                            <div className={styles["error-alert"]} style={{ flexDirection: 'column', alignItems: 'flex-start', gap: '8px' }}>
                                ...
                                {resendSuccess && (
                                  <span style={{ color: '#28a745', fontSize: '13px', marginLeft: '28px', fontWeight: '500' }}>
                        ...
                        <div className={styles["signup-section"]}>
                            <p>Don't you have an account? <Link to="/register" className={styles["signup-link"]}>Sign up</Link></p>
                        </div>
